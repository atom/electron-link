...
suite('generateSnapshotScript({baseDirPath, mainPath})', () => {
  ...
  test('row translation', async () => {
    ...
    assert.deepEqual(snapshotResult.translateSnapshotRow(262), {relativePath: '<embedded>', row: 262})
    assert.deepEqual(snapshotResult.translateSnapshotRow(263), {relativePath: '../fixtures/module-1/index.js', row: 0})
    assert.deepEqual(snapshotResult.translateSnapshotRow(276), {relativePath: '../fixtures/module-1/index.js', row: 13})
    assert.deepEqual(snapshotResult.translateSnapshotRow(278), {relativePath: '<embedded>', row: 278})
    assert.deepEqual(snapshotResult.translateSnapshotRow(283), {relativePath: '../fixtures/module-1/dir/a.js', row: 4})
    assert.deepEqual(snapshotResult.translateSnapshotRow(295), {relativePath: '../fixtures/module-1/node_modules/a/index.js', row: 0})
    assert.deepEqual(snapshotResult.translateSnapshotRow(300), {relativePath: '<embedded>', row: 300})
