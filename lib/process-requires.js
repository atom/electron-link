...
module.exports = function (options) {
  ...
  recast.types.visit(ast, {
    visitCallExpression: function (astPath) {
      if (isTopLevelASTPath(astPath) && isStaticRequire(astPath)) {
        ...
        if (options.didFindRequire(absoluteModulePath || moduleName)) {
  ...
  function replaceAssignmentOrDeclarationWithLazyFunction (astPath) {
    ...
    while (parentPath != null && parentPath.scope === astPath.scope) {
      ...
      if (parentNode.type === 'AssignmentExpression') {
        ...
        assert(astPath.scope.declares(assignmentLhs.name), 'Assigning a deferred module to a variable that was not declared in this scope is not supported!')
